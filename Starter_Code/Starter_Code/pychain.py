...
sender_data = st.text_input("Sender, please input your Infomration")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_data = st.text_input("Please enter the reciever Information")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_data = st.text_input("How much would you like to send?")
